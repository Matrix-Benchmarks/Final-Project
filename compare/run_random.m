...
% TODO: Noise?
% This function returns how close each algorithm was at the end of max_time
function run_random(rank, matrix_size, fraction_shown, file_name, max_time)
    ...
    output_file = fopen('output/' + file_name, 'a');
