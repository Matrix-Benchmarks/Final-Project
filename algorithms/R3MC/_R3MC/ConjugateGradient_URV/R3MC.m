function [model, infos] = R3MC(data_ts, data_ls, model, max_time)
    ...
    %
    % data_ts: data_ts.Gs: Original left low-rank factor
    %        : datat_ts.Hs: Original right low-rank factor
    %
...
% - set sensible default parameters
    ...
    if ~isfield(params,'verb'); params.verb = true; end % Verbosity
    ...
    if ~isfield(params,'maxiter'); params.maxiter = 500; end % Maximum number of iterations
